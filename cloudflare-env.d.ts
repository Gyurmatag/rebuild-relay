/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2d6ce5128c36b73e5177a893438b0199)
// Runtime types generated with workerd@1.20260603.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	AUDIO_BUCKET: R2Bucket;
	DB: D1Database;
	TWILIO_MESSAGING_SERVICE_SID: "";
	PUBLIC_BASE_URL: "https://rebuild-relay.cfi-ops.workers.dev";
	TWILIO_PHONE_NUMBER: string;
	DISPATCH_NUMBERS: string;
	TWILIO_SKIP_VALIDATION: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TWILIO_MESSAGING_SERVICE_SID" | "PUBLIC_BASE_URL" | "TWILIO_PHONE_NUMBER" | "DISPATCH_NUMBERS" | "TWILIO_SKIP_VALIDATION">> {}
}
